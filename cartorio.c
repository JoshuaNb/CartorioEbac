...
{
	//Inicio cridação de variaveis/string
	char arquivo[40];
	char cpf[40];
	char nome[40];
	char sobrenome[40];
	char cargo[40];
	//Final cridação de variaveis/string
	
	printf("Digite o CPF para ser cadastrado: "); //Coletando a informação do usuario
...
int consulta ()
{
	...
	if(file == NULL)
	{
		printf("Não foi possivel abrir p arquivo \n");
	}
